...
class Cooked_Settings {
	...
	public static function field_text( $field_name, $placeholder ){
		global $_cooked_settings;
		echo '<p>';
			echo '<input id="cooked_field--' . esc_attr( $field_name ) . '" type="text"' . ( $placeholder ? ' placeholder="' . esc_attr( $placeholder ) . '"' : '' ) . ' name="cooked_settings[' . $field_name . ']" value="' . ( isset( $_cooked_settings[$field_name] ) && $_cooked_settings[$field_name] ? $_cooked_settings[$field_name] : '' ) . '">';
		echo '</p>';
	}
